...
const buttonVariants = cva(
  // 🔒 Base button styles (UI buttons)
  "inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium ring-offset-background transition-all " +
    ...
    "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost:
          // 🧠 Ghost brukes i Calendar → MÅ være kompakt
          "hover:bg-accent hover:text-accent-foreground whitespace-normal gap-0",
